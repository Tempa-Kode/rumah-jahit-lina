                    ...
                    <div class="row">
                        ...
                        <div class=" col-lg-8 d-none d-lg-block">
                            <div class="header-center">
                                <form class="form-search-product m-auto">
                                    <div class="select-category">
                                        ...
                                        <ul class="select-options">
                                            ...
                                            <li class="link" rel="storage-digital-devices"><span>Storage & Digital
                                                    Devices</span></li>
                                            <li class="link" rel="tv-computer-screen"><span>TV & Computer Screen</span>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class=" col-lg-2 col-6 d-flex align-items-center justify-content-end">
                            <div class="header-right">
                                <ul class="nav-icon justify-content-xl-center">
                                    ...
                                    <li class="nav-support d-none d-xl-block">
                                        <a href="wishlist.html" class="link link-fill nav-icon-item relative">
                                            <span>
                                            ...
                                            <span class="count-box style-pst-2 d-none d-xxl-flex">04</span>
                                            <p class="body-small">
                                                Wishlist
                                            </p>
                                        </a>
            ...
            <div class="header-bottom d-none d-xl-block">
                <div class="container">
                    <div class="row">
                                                                ...
                                                                <g clip-path="url(#clip0_1739_24868)">
                                                                    ...
                                                                    <g mask="url(#mask0_1739_24868)">
                                                                        ...
                                                                        <path d="M13.1156 14.8111L13.6318 15.3274"
                                                                            ...
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                        <path d="M5.16481 6.86035L4.64856 6.3441"
                                                                            stroke="black" stroke-miterlimit="10"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                    </g>
                                ...
                                <nav class="main-nav-menu">
                                    <ul class="nav-list">
                                        <li class="nav-item pst-unset">
                                            <a href="#" class="item-link link body-md-2 fw-semibold">
                                                <span>Home</span>
                                                    ...
                                                    <ul class="row-demo">
                                                        <li class="demo-item">
                                                            <a href="index.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-1.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-1.webp') }}" alt=""
                                                                        class="lazyload">
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-2.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-2.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-2.webp') }}" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-3.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-3.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-3.webp') }}" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                    </div>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-4.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-4.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-4.webp') }}" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                    </div>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-5.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-5.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-5.webp') }}" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span>Trend</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-6.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="{{ asset('home/images/demo/home-6.webp') }}"
                                                                        data-src="{{ asset('home/images/demo/home-6.webp') }}" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span>Trend</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-7.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="images/demo/home-7.webp"
                                                                        data-src="images/demo/home-7.webp" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-8.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="images/demo/home-8.webp"
                                                                        data-src="images/demo/home-8.webp" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-9.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="images/demo/home-9.webp"
                                                                        data-src="images/demo/home-9.webp" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-10.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="images/demo/home-10.webp"
                                                                        data-src="images/demo/home-10.webp" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                        ...
                                                        <li class="demo-item">
                                                            <a href="home-11.html">
                                                                <div class="demo-image relative">
                                                                    <img width="199" height="218"
                                                                        src="images/demo/home-11.webp"
                                                                        data-src="images/demo/home-11.webp" alt=""
                                                                        class="lazyload">
                                                                    <div class="demo-label">
                                                                        <span class="demo-new">New</span>
                                                                        <span class="demo-hot">Hot</span>
                                                ...
                                                <div class="wrapper-sub-menu">
                                                    ...
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            ...
                                                            <li>
                                                                <a href="track-your-order.html" class="body-md-2 link">
                        ...
                        <div class="col-xxl-3 col-4 d-flex align-items-center justify-content-end">
                            <div class="header-bt-right">
                                <div class="tf-cur bar-lang type-2">
                                    <div class="tf-cur-item gap-0">
                                    ...
                                    <div class="tf-cur-item">
                                        <i class="icon icon-global gap-0"></i>
                                        <div class="tf-lans">
                            ...
                            <div class="ft-logo">
                                ...
                                <div class="method-payment">
                                    ...
                                    <ul class="method-list">
                                        ...
                                        <li>
                                            <img src="images/payment/paypal.svg" alt="Payment">
                                        </li>
                                        <li>
                                            <img src="images/payment/discover.svg" alt="Payment">
                                        </li>
                                        <li>
                                            <img src="images/payment/master.svg" alt="Payment">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <li class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="ft-menu-list">
                                            ...
                                            <li><a href="shop-default.html" class="link">Waterproof Headphones</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="ft-menu-list">
                                            ...
                                            <li><a href="track-your-order.html" class="link">Track your Order</a>
                                            </li>
                                ...
                                <div id="sib-form-container" class="sib-form-container">
                                    ...
                                    <div id="sib-container" class="sib-container--large sib-container--vertical">
                                        <form id="sib-form" method="POST" class="form-newsletter"
                                            action="https://3c02c1a1.sibforms.com/serve/MUIFABp-6TRH_ZaK3WSmgGEDN5JKtMVuO6AlfuFlAQ5zTnRMTM9BUGeezu_2xii-Q69nQvGvpnGbcxXU67nGQ5uDYgSnl0-UsYaPkTQENX9KjaNOrfvCz8rpEWGmf8Hp7zP5oS_WBIdftR5tby8mzBWr8pGQ7408FpU45UnQz5_Noqye8awDqyH6FqstWhwflIgsFbsd_AHEpMrk"                                                data-type="subscription">
    ...
    <div class="modal fade modalDemo" id="modalDemo">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="heading">
                    <h5 class="demo-title fw-semibold text-center">Ultimate HTML Theme</h5>
                    <span class="icon-close icon-close-popup link cs-pointer" data-bs-dismiss="modal"></span>
                </div>
                <div class="demo-menu-list">
                    <ul class="row-demo">
                        <li class="demo-item">
                            <a href="index.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-1.webp"
                                        data-src="images/demo/home-1.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span>Trend</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-2.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-2.webp"
                                        data-src="images/demo/home-2.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">New</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-3.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-3.webp"
                                        data-src="images/demo/home-3.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <li class="demo-item">
                            <a href="home-4.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-4.webp"
                                        data-src="images/demo/home-4.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <li class="demo-item">
                            <a href="home-5.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-5.webp"
                                        data-src="images/demo/home-5.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span>Trend</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-6.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-6.webp"
                                        data-src="images/demo/home-6.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span>Trend</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-7.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-7.webp"
                                        data-src="images/demo/home-7.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">Hot</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-8.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-8.webp"
                                        data-src="images/demo/home-8.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">Hot</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-9.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-9.webp"
                                        data-src="images/demo/home-9.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">Hot</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-10.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-10.webp"
                                        data-src="images/demo/home-10.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">Hot</span>
                                    </div>
                        ...
                        <li class="demo-item">
                            <a href="home-11.html">
                                <div class="demo-image relative">
                                    <img width="199" height="218" src="images/demo/home-11.webp"
                                        data-src="images/demo/home-11.webp" alt="" class="lazyload">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                ...
                                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                                    <li class="nav-mb-item">
                                        ...
                                        <div id="dropdown-menu-home" class="collapse">
                                            <ul class="sub-nav-menu">
                                                ...
                                                <li><a href="home-2.html" class="sub-nav-link">Home 2</a></li>
                                    ...
                                    <li class="nav-mb-item active">
                                        ...
                                        <div id="dropdown-menu-shop" class="collapse">
                                            <ul class="sub-nav-menu">
                                                <li>
                                                    <a href="#shop_layout" class="sub-nav-link collapsed active"
                                                        data-bs-toggle="collapse" aria-expanded="true"
                                                        ...
                                                        <ul class="sub-nav-menu sub-menu-level-2">
                                                            <li>
                                                                <a href="shop-default.html"
                                                                    class="sub-nav-link body-md-2 active">
                                                                    <span>Shop Default</span>
                                                                </a>
                                                            </li>
                                                            <li>
